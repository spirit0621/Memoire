...
public class LigneFicheDePaie {
    ...
    public Integer getFicheDePaieId() {
        return ficheDePaieId;
    }

    public void setFicheDePaieId(Integer ficheDePaieId) {
        this.ficheDePaieId = ficheDePaieId;
    }
