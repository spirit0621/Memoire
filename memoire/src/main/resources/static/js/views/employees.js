                ...
                <tr class="animate-fade-in-up">
                            ...
                            <img src="${e.avatar}" class="avatar avatar-sm">
                             <div>
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="badge badge-indigo" style="font-size: 10px; padding: 1px 6px;">${e.position || 'Employé'}</span>
                    ...
                    <td class="text-right">
                        <div class="flex justify-end gap-1">
                            <button class="btn btn-ghost btn-sm text-blue-600" title="Modifier" onclick="ui.openEmployeeModal(${e.id})"><i class="fa-solid fa-pen-to-square"></i></button>
